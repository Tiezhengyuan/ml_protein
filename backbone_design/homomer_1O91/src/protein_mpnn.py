...
from ca_protein_features import CA_ProteinFeatures
from protein_features import ProteinFeatures
from enc_layer import EncLayer
from dec_layer import DecLayer
...
class ProteinMPNN(nn.Module):
    ...
    def forward(self, X, S, mask, chain_M, residue_idx, chain_encoding_all, 
        ...
        if not use_input_decoding_order:
            #[numbers will be smaller for places where chain_M = 0.0 
            # and higher for places where chain_M = 1.0]
        ...
        for t_ in range(N_nodes):
            ...
            if (mask_gathered==0).all(): #for padded or missing regions only
                ...
                for l, layer in enumerate(self.decoder_layers):
                    ...
                    h_ESV_t = torch.gather(mask_bw, 1, t[:,None,None,None]\
                        .repeat(1,1,mask_bw.shape[-2], mask_bw.shape[-1])) \
    ...
    def tied_sample(self, X, randn, S_true, chain_mask, 
            chain_encoding_all, residue_idx, mask=None, 
            temperature=1.0, omit_AAs_np=None, bias_AAs_np=None, 
            chain_M_pos=None, omit_AA_mask=None, pssm_coef=None, 
            pssm_bias=None, pssm_multi=None, 
            pssm_log_odds_flag=None, pssm_log_odds_mask=None, 
            pssm_bias_flag=None, tied_pos=None, 
    ...
    def conditional_probs(self, X, S, mask, chain_M, 
